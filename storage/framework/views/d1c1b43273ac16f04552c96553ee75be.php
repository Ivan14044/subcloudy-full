<?php $__env->startSection('title', __('admin.add_service_account')); ?>

<?php $__env->startSection('content_header'); ?>
    <h1><?php echo e(__('admin.add_service_account')); ?></h1>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('admin.service-accounts.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                            ...
                                            data-link="<?php echo e(e(data_get($service->params, 'link', 'https://google.com/'))); ?>"
                                            data-title="<?php echo e(e(data_get($service->params, 'title', 'SubCloudy'))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('expiring_at')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('max_users')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                ><?php echo e(old('cookies_import')); ?></textarea>
                                <small class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('credentials.email')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('credentials.password')); ?>">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/subcloudy/backend/resources/views/admin/service-accounts/create.blade.php ENDPATH**/ ?>