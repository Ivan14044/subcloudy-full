<template>
    <fieldset class="theme-switcher">
        ...
        <svg style="display: none" class="theme-switcher__filter">
            <filter id="theme-switcher-glass" primitiveUnits="objectBoundingBox">
        ...
        >
            ...
            <svg class="theme-switcher__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36 36">
                <path fill="currentColor" fill-rule="evenodd" d="M18 12a6 6 0 1 1 0 12 6 6 0 0 1 0-12Zm0 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z" clip-rule="evenodd" />
        ...
        <!-- Анимированный индикатор выбранной темы -->
        <div class="theme-switcher__toggle" :class="{ 'theme-switcher__toggle--dark': isDark }"></div>
    </fieldset>
</template>
...
const previousTheme = ref<'light' | 'dark'>(isDark.value ? 'dark' : 'light');

const setTheme = (dark: boolean) => {
    previousTheme.value = isDark.value ? 'dark' : 'light';
    applyTheme(dark);
};
...
.dark .theme-switcher {
    ...
    box-shadow: 
        ...
        inset 1.8px 3px 0px -2px rgba(255, 255, 255, 0.1),
...
.dark .theme-switcher__option:hover {
    color: #03d5ff;
}
...
.dark .theme-switcher__option--active {
    color: #e1e1e1;
}
...
.theme-switcher__toggle {
    ...
    box-shadow: 
        inset 0 0 0 1px rgba(255, 255, 255, 0.1),
        inset 2px 1px 0px -1px rgba(255, 255, 255, 0.5),
...
.dark .theme-switcher__toggle {
    background-color: rgba(31, 41, 55, 0.4);
    box-shadow: 
        inset 0 0 0 1px rgba(255, 255, 255, 0.03),
        inset 2px 1px 0px -1px rgba(255, 255, 255, 0.1),
