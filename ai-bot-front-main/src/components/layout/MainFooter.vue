<template>
    <footer
        class="bg-[#161719] min-h-[100px] text-white rounded-t-[40px] xl:rounded-t-[100px] px-6 py-16 position-relative mt-auto"
    >
        <div
        ...
        >
            <p class="copyright text-gray-500 text-[16px] font-normal md:mb-3">
                {{ $t('footer.copyright') }}
            </p>
