...
Route::prefix('admin')
    ...
    ->group(function () {
        // Страницы входа администратора
        // ВАЖНО: не используем middleware guest, чтобы не редиректить уже авторизованных фронтовых пользователей на главную.
        // Это позволяет открывать форму админ-логина даже при активной пользовательской сессии.
