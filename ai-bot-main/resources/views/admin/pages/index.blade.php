        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('admin.pages_list') }}</h3>
                    <a href="{{ route('admin.pages.create') }}" class="btn btn-primary float-right">+ {{ __('admin.add') }}</a>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {{ __('admin.are_you_sure_delete_page') }}
                                                </div>
