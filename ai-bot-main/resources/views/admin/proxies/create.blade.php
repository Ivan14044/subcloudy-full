...
@section('title', __('admin.add_proxy'))

@section('content_header')
    <h1>{{ __('admin.add_proxy') }}</h1>
@stop
                    ...
                    <form method="POST" action="{{ route('admin.proxies.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror">
                                ...
                                <option value="SOCKS4" {{ old('type') == 'SOCKS4' ? 'selected' : '' }}>SOCKS4</option>
                                <option value="SOCKS5" {{ old('type') == 'SOCKS5' ? 'selected' : '' }}>SOCKS5</option>
                            </select>
                            @error('type')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="credentials" id="credentials" class="form-control @error('credentials') is-invalid @enderror" value="{{ old('credentials') }}">
                            @error('credentials')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="expiring_at" id="expiring_at" class="form-control @error('expiring_at') is-invalid @enderror" value="{{ old('expiring_at') }}">
                            @error('expiring_at')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
